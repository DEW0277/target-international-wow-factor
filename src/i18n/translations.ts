...
export const translations: Record<Language, Record<string, string>> = {
  uz: {
    ...
    "hero.subtitle": "TARGET International School — Cambridge dasturi, STEM ta'limi va individual yondashuv orqali bolalaringizni jahon universitetlariga tayyorlaymiz",
    "hero.cta.apply": "Qabul uchun ariza",
    "hero.cta.telegram": "Telegram orqali aloqa",
    
    // Trust badges
    "badge.curriculum": "Xalqaro dastur",
    "badge.stem": "STEM & Robototexnika",
    "badge.ielts": "IELTS natijalari",
    "badge.safety": "Xavfsiz kampus",
    ...
    "about.missionText": "Har bir bolaning iste'dodini kashf etib, ularni 21-asr ko'nikmalariga ega, global fikrlaydigan shaxslar sifatida tarbiyalash.",
    "about.vision": "Bizning tasavvurimiz",
    "about.visionText": "O'zbekistondagi eng yetakchi xalqaro maktab bo'lish va bitiruvchilarimizni dunyoning eng nufuzli universitetlariga yuborish.",
