...
export const translations: Record<Language, Record<string, string>> = {
  ...
  ru: {
    ...
    // Testimonials
    "testimonials.title": "Отзывы родителей и учеников",
    "testimonials.subtitle": "Что говорят о нашей команде",
    ...
    "about.values.excellence.title": "Совершенство (Excellence)",
    "about.values.excellence.desc": "Мы стремимся к высочайшим стандартам академических достижений и характера",
    "about.values.resilience.title": "Стойкость (Resilience)",
    "about.values.resilience.desc": "Развитие упорства и адаптивности",
    "about.values.globalcitizenship.title": "Глобальное гражданство",
    "about.values.globalcitizenship.desc": "Ценить разнообразие и вносить вклад в местные/глобальные сообщества",
    "about.values.protecting.title": "Защита (Protecting)",
    "about.values.protecting.desc": "Бережное отношение к нашей планете и защита окружающей среды",
    "about.values.innovation.title": "Инновации (Innovation)",
    "about.values.innovation.desc": "Поощрение творческого мышления и решения проблем",
    "about.values.helping.title": "Помощь (Helping)",
    "about.values.helping.desc": "Улучшение жизни и поддержка других",
    "about.values.integrity.title": "Честность (Integrity)",
    "about.values.integrity.desc": "Действовать с честностью, справедливостью и моральной смелостью",
    
    "about.philosophy.title": "Философия образования",
    "about.philosophy.academic.title": "Академическая строгость",
    "about.philosophy.academic.desc": "Методы обучения, основанные на исследованиях, и международная учебная программа",
    "about.philosophy.holistic.title": "Комплексное развитие",
    "about.philosophy.holistic.desc": "Программы лидерства, социально-эмоциональное обучение, подготовка к карьере/университету с начальных классов",
    "about.philosophy.ethos.title": "Этика образования (Ethos)",
    "about.philosophy.ethos.desc": "Международные образовательные стандарты, уважение узбекской культуры и ценностей, многоязычная образовательная среда",
  ...
  en: {
    ...
    // Testimonials
    "testimonials.title": "Parent and Student Reviews",
    "testimonials.subtitle": "What they say about our team",
    ...
    "about.values.excellence.desc": "Striving for the highest standards in academics and character",
    "about.values.resilience.title": "Resilience",
    "about.values.resilience.desc": "Developing perseverance and adaptability",
    "about.values.globalcitizenship.title": "Global Citizenship",
    "about.values.globalcitizenship.desc": "Valuing diversity and contributing to local/global communities",
    "about.values.protecting.title": "Protecting",
    "about.values.protecting.desc": "Preserving our planet and environmental conservation",
    "about.values.innovation.title": "Innovation",
    "about.values.innovation.desc": "Encouraging creative thinking and problem solving",
    "about.values.helping.title": "Helping",
    "about.values.helping.desc": "Working to improve lives and lift others up",
    "about.values.integrity.title": "Integrity",
    "about.values.integrity.desc": "Acting with honesty, fairness, and moral courage",
    
    "about.philosophy.title": "Educational Philosophy",
    "about.philosophy.academic.title": "Academic Rigor",
    "about.philosophy.academic.desc": "Research-based teaching methods and international curriculum",
    "about.philosophy.holistic.title": "Holistic Development",
    "about.philosophy.holistic.desc": "Leadership programs, social-emotional learning, university prep from primary",
    "about.philosophy.ethos.title": "Educational Ethos",
    "about.philosophy.ethos.desc": "International standards respecting Uzbek culture and values in a multilingual environment",
  ...
  de: {
    ...
    "about.values.excellence.title": "Exzellenz (Excellence)",
    "about.values.excellence.desc": "Streben nach höchsten Standards bei akademischen Leistungen und Charakter",
    "about.values.resilience.title": "Resilienz (Resilience)",
    "about.values.resilience.desc": "Entwicklung von Ausdauer und Anpassungsfähigkeit",
    "about.values.globalcitizenship.title": "Globale Bürgerschaft",
    "about.values.globalcitizenship.desc": "Vielfalt schätzen und zu lokalen/globalen Gemeinschaften beitragen",
    "about.values.protecting.title": "Schutz (Protecting)",
    "about.values.protecting.desc": "Erhaltung unseres Planeten und Umweltschutz",
    "about.values.innovation.title": "Innovation",
    "about.values.innovation.desc": "Förderung von kreativem Denken und Problemlösung",
    "about.values.helping.title": "Hilfe (Helping)",
    "about.values.helping.desc": "Sich für ein besseres Leben und die Unterstützung anderer einsetzen",
    "about.values.integrity.title": "Integrität (Integrity)",
    "about.values.integrity.desc": "Mit Ehrlichkeit, Fairness und moralischem Mut handeln",
    
    "about.philosophy.title": "Bildungsphilosophie",
    "about.philosophy.academic.title": "Akademische Strenge",
    "about.philosophy.academic.desc": "Forschungsbasierte Lehrmethoden und internationaler Lehrplan",
    "about.philosophy.holistic.title": "Ganzheitliche Entwicklung",
    "about.philosophy.holistic.desc": "Führungsprogramme, sozial-emotionales Lernen, Universitätsvorbereitung ab der Grundschule",
    "about.philosophy.ethos.title": "Bildungsethos (Ethos)",
    "about.philosophy.ethos.desc": "Internationale Standards, Respekt vor der usbekischen Kultur und Werten in einer mehrsprachigen Umgebung",
    ...
    // Testimonials
    "testimonials.title": "Eltern- und Schülerbewertungen",
    "testimonials.subtitle": "Was sie über unser Team sagen",
